...
Common.Tips.prototype = {
    ...
    _create: function () {
        ...
        this.obj = $('<div class="ui-tips"><i class="icon icon-sound2"></i><span class="close" title="关闭">X</span></div>').append(opts.content);
...
$.fn.ruleMultiCheckbox = function () {
    var multiCheckbox = function (parentObj) {
        ...
        parentObj.find(":checkbox").each(function () {
            ...
            var value = $(this).val();
            var newObj = $('<a href="javascript:;" data-value="'+ value +'">' + parentObj.find('label').eq(indexNum).text() + '</a>').appendTo(divObj); /*查找对应Label创建选项*/
...
$.fn.ruleMultiPorp = function () {
    var multiPorp = function (parentObj) {
        ...
        parentObj.find(":checkbox").each(function () {
            ...
            var newObj = $('<a href="javascript:;" data-value="'+ value +'">' + parentObj.find('label').eq(indexNum).text() + '</a><i></i>').appendTo(liObj); /*查找对应Label创建选项*/
            if ($(this).prop("checked") == true) {
